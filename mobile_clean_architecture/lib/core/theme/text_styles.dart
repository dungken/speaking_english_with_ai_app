...
class TextStyles {
  ...
  static TextStyle h1(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  static TextStyle h2(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  static TextStyle h3(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  static TextStyle body(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  static TextStyle secondary(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  static TextStyle caption(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
  ...
  // Button text style
  static TextStyle button(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
      fontSize: ResponsiveLayout.getBodyTextSize(context),
      fontWeight: FontWeight.w600,
      letterSpacing: 0.2,
  ...
  // Link style
  static TextStyle link(BuildContext context, {Color? color, bool isDarkMode = false}) {
    return TextStyle(
      fontSize: ResponsiveLayout.getBodyTextSize(context),
      fontWeight: FontWeight.w500,
